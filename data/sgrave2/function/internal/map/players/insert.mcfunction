...
##> PID
execute store result storage sgrave2:common players[-1].player.pid int 1 store result score @s sgrave2.pid run scoreboard players add .global sgrave2.pid 1
