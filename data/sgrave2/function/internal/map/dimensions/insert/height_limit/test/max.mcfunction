...
$execute if score .conditions sgrave2.temp_var matches 1 run return run scoreboard players set .max_height sgrave2.temp_var $(height)
execute store result storage sgrave2:common temp.args.height int 1 run scoreboard players remove .height sgrave2.temp_var 16
execute unless score .height sgrave2.temp_var matches ..-2031 run function sgrave2:internal/map/dimensions/insert/height_limit/test/max with storage sgrave2:common temp.args