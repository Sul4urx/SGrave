...
## Give XP
execute as @p[tag=sgrave2.temp.grave.interactor] at @s run function sgrave2:internal/grave/open/give_xp with entity @n[tag=sgrave2.temp.grave.base] item.components.minecraft:custom_data.sgrave2:common.xp
