...
execute store result storage sgrave2:common temp.args.value int 1 run data get storage sgrave2:common configs.value.costs.grave_opening_costs.non_owners.xp.levels -1
