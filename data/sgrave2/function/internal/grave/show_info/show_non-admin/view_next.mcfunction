...
execute store result storage sgrave2:common temp.gid int 1 run scoreboard players get @s sgrave2.show_grave_info.view_next
...
execute store result score .return_value sgrave2.temp_var run function sgrave2:internal/grave/show_info/show_non-admin/view_next/loop with storage sgrave2:common temp.args1
