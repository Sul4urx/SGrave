...
## Status
execute unless score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status{destruction_type:"opened"} unless score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.opened_by", "fallback": "  §bStatus: §cOpened by %s", "with": [{"nbt": "graves[-1].data.status.destroyer.name", "color": "red", "storage": "sgrave2:common"}]}

execute unless score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status{destruction_type:"opened"} if score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.opened", "fallback": "  §bStatus: §cOpened"}


execute unless score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status{destruction_type:"broken"} unless score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.broken_by", "fallback": "  §bStatus: §cBroken by %s", "with": [{"nbt": "graves[-1].data.status.destroyer.name", "color": "red", "storage": "sgrave2:common"}]}

execute unless score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status{destruction_type:"broken"} if score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.broken", "fallback": "  §bStatus: §cBroken"}


execute unless score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status{destruction_type:"despawned"} run tellraw @s {"translate": "sgrave2.grave_info.status.despawned", "fallback": "  §bStatus: §cDespawned"}


execute if score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if data storage sgrave2:common graves[-1].data.status.destroyer unless score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.broken", "fallback": "  §bStatus: §cDestroyed by %s", "with": [{"nbt": "graves[-1].data.status.destroyer.name", "color": "red", "storage": "sgrave2:common"}]}

execute if score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 unless score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 unless data storage sgrave2:common graves[-1].data.status.destroyer run tellraw @s {"translate": "sgrave2.grave_info.status.broken", "fallback": "  §bStatus: §cDestroyed"}

execute if score (graves/show_grave_info/bn/destruction_type) sgrave2.config matches 0 if score (graves/show_grave_info/bn/destroyer) sgrave2.config matches 0 run tellraw @s {"translate": "sgrave2.grave_info.status.broken", "fallback": "  §bStatus: §cDestroyed"}
...
$execute unless data storage sgrave2:common graves[-1].data.status{destroyed:1b} run tellraw @s {\
  ...
  "with": [\
    {\
      ...
      "clickEvent": {\
        "action": "run_command",\
        "value": "/trigger sgrave2.show_grave_info.view_previous set $(gid)"\
      }\
    },\
    {\
      ...
      "clickEvent": {\
        ...
        "value": "/trigger sgrave2.remote_open_grave set $(gid)"\
      }\
    },\
    {\
      "translate": "sgrave2.grave_info.menu.back",\
      ...
      "clickEvent": {\
        "action": "run_command",\
        "value": "/trigger sgrave2.show_grave_info.view_next set $(gid)"\
      }\
    }\
  ]\
}
