...
execute store result score .loop_count_2 sgrave2.temp_var if data storage sgrave2:common configs.value.players.blacklist_items[]
data modify storage sgrave2:common temp.config.blacklist_items_copy set from storage sgrave2:common configs.value.players.blacklist_items
