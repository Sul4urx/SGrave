...
execute store result score .xp_cost_levels sgrave2.temp_var run data get storage sgrave2:common configs.costs.grave_generation_costs.with_item.xp.levels
