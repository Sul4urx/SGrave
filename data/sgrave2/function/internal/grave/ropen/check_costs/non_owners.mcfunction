...
execute if score (config:costs/grave_ropening_costs/non_owners/gamemodes/survival) sgrave2.config matches 0 if entity @s[gamemode=survival] run return run scoreboard players set .check_costs.gamemodes sgrave2.temp_var 0
execute if score (config:costs/grave_ropening_costs/non_owners/gamemodes/adventure) sgrave2.config matches 0 if entity @s[gamemode=adventure] run return run scoreboard players set .check_costs.gamemodes sgrave2.temp_var 0
execute if score (config:costs/grave_ropening_costs/non_owners/gamemodes/creative) sgrave2.config matches 0 if entity @s[gamemode=creative] run return run scoreboard players set .check_costs.gamemodes sgrave2.temp_var 0
...
execute if score .player_xp sgrave2.temp_var >= (config:costs/grave_ropening_costs/non_owners/xp) sgrave2.config run scoreboard players set .check_costs.xp sgrave2.temp_var 1
