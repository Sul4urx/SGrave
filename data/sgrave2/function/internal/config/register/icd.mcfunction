...
execute store result storage sgrave2:common configs.icd.activate_for.value byte 1 run scoreboard players get (graves/icd/activate_for) sgrave2.config
...
execute store result storage sgrave2:common configs.icd.switch_text_display.value byte 1 run scoreboard players get (graves/icd/switch_text_display) sgrave2.config
...
execute store result storage sgrave2:common configs.icd.item_cycle_cooldown.value int 1 run scoreboard players get (graves/icd/item_cycle_cooldown) sgrave2.config
...
execute store result storage sgrave2:common configs.icd.requires_sneaking.value byte 1 run scoreboard players get (graves/icd/requires_sneaking) sgrave2.config
