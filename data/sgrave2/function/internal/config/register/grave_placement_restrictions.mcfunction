...
execute store result storage sgrave2:common configs.grave_placement_restrictions.above_build_height_limit.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/above_build_height_limit) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.below_build_height_limit.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/below_build_height_limit) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.on_water.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/on_water) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.in_water.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/in_water) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.on_lava.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/on_lava) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.in_lava.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/in_lava) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.on_non_solid_blocks.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/on_non_solid_blocks) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.in_solid_blocks.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/in_solid_blocks) sgrave2.config
...
execute store result storage sgrave2:common configs.grave_placement_restrictions.on_air.value byte 1 run scoreboard players get (graves/grave_placement_restrictions_restrictions/on_air) sgrave2.config
