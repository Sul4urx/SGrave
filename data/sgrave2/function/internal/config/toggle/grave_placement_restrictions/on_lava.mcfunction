...
## Toggle value
scoreboard players add <grave_placement_restrictions.on_lava> sgrave2.config 1
execute if score <grave_placement_restrictions.on_lava> sgrave2.config matches 2.. run scoreboard players set <grave_placement_restrictions.on_lava> sgrave2.config 0
