...
## Toggle value
scoreboard players add (graves/grave_placement_restrictions_restrictions/on_lava) sgrave2.config 1
execute if score (graves/grave_placement_restrictions_restrictions/on_lava) sgrave2.config matches 2.. run scoreboard players set (graves/grave_placement_restrictions_restrictions/on_lava) sgrave2.config 0
