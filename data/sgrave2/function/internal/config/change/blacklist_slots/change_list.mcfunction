...
execute store result score .is_valid sgrave2.temp_var run function sgrave2:internal/config/change/blacklist_slots/change_list/check_value with storage sgrave2:common temp.config
...
execute if data storage sgrave2:common temp.config.value[] if score .is_valid sgrave2.temp_var matches 1 run data modify storage sgrave2:common configs.players.blacklist_slots set from storage sgrave2:common temp.config.value
execute if data storage sgrave2:common temp.config{value:[]} run data modify storage sgrave2:common configs.players.blacklist_slots set value []
