...
execute if data storage sgrave2:common temp.config.value[] if score .is_valid sgrave2.temp_var matches 1 run data modify storage sgrave2:common configs.blacklist_slots set from storage sgrave2:common temp.config.value
execute if data storage sgrave2:common temp.config{value:[]} run data modify storage sgrave2:common configs.blacklist_slots set value []
