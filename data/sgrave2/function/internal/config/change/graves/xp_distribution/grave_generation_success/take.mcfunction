...
execute unless predicate {\
  ...
  "translate": "sgrave2.change_config_message.graves.xp_distribution.grave_generation_success.take.fail",\
...
execute store result score (graves/xp_distribution/grave_generation_success/take) sgrave2.config run data get storage sgrave2:common temp.config.value
