...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.on_air.text_value",\
...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.on_water.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
  ...
  {\
    "translate": "sgrave2.space_between_configs.grave_placement_restrictions.on_water..in_water",\
    "fallback": "                  §l   §r" \
  },\
  {\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.in_water.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.on_lava.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
  ...
  {\
    "translate": "sgrave2.space_between_configs.grave_placement_restrictions.on_lava..in_lava",\
    "fallback": "                   §l   §r" \
  },\
  {\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.in_lava.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.on_non_solid_blocks.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
  ...
  {\
    "translate": "sgrave2.space_between_configs.grave_placement_restrictions.on_non_solid_blocks..in_solid_blocks",\
    "fallback": "        " \
  },\
  {\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.in_solid_blocks.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.above_build_height_limit.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
  ...
  {\
    "translate": "sgrave2.space_between_configs.grave_placement_restrictions.above_build_height_limit..below_build_height_limit",\
    "fallback": " §l   §r" \
  },\
  {\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_placement_restrictions.below_build_height_limit.text_value",\
        "storage": "sgrave2:common" \
      }\
    ],\
    "hover_event": {\
