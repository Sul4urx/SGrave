  ...
  {\
    ...
    "hover_event": {\
      ...
      "value": {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.owners.items",\
  ...
  {\
    ...
    "with": [\
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.owners.gamemodes.survival.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
      ...
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.owners.gamemodes.adventure.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
      ...
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.owners.gamemodes.creative.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
  ...
  {\
    ...
    "hover_event": {\
      ...
      "value": {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.non_owners.items",\
            "storage": "sgrave2:common",\
            "color": "dark_gray"\
          }\
        ]\
...
tellraw @s [\
  ...
  {\
    ...
    "with": [\
      {\
        "nbt": "configs.grave_opening_costs.non_owners.xp.levels.text_value",\
        "storage": "sgrave2:common",\
        "color": "aqua"\
      }\
    ],\
  ...
  {\
    ...
    "with": [\
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.non_owners.gamemodes.survival.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
      ...
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.non_owners.gamemodes.adventure.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
      ...
      {\
        ...
        "with": [\
          {\
            "nbt": "configs.grave_opening_costs.non_owners.gamemodes.creative.text_value",\
            "storage": "sgrave2:common"\
          }\
        ],\
        "hover_event": {\
