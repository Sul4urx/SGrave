...
execute store result storage sgrave2:common configs.despawn_time.grave.value int 1 run scoreboard players get (graves/despawn_time) sgrave2.config
...
execute store result storage sgrave2:common configs.despawn_time.item.value int 1 run scoreboard players get (dropped_contents/item_despawn_time) sgrave2.config
...
execute store result storage sgrave2:common configs.despawn_time.xp.value int 1 run scoreboard players get (dropped_contents/xp_despawn_time) sgrave2.config
...
execute store result storage sgrave2:common configs.mod_compatibility_mode.item_collection_distance.value int 1 run scoreboard players get (general/mod_compatibility_mode/item_collection_distance) sgrave2.config
...
execute store result storage sgrave2:common configs.change_gamerules.value byte 1 run scoreboard players get (general/change_gamerules) sgrave2.config
...
execute store result storage sgrave2:common configs.glowing_graves.value byte 1 run scoreboard players get (graves/glowing_graves) sgrave2.config
...
execute store result storage sgrave2:common configs.mod_compatibility_mode.value byte 1 run scoreboard players get (general/mod_compatibility_mode) sgrave2.config
...
execute store result storage sgrave2:common configs.tell_grave_mini_info.value byte 1 run scoreboard players get (graves/tell_grave_mini_info) sgrave2.config
